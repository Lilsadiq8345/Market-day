...
-- First, unschedule any old cron job with the same name to avoid duplicates
SELECT cron.unschedule('daily-market-reminders');
...
SELECT cron.schedule(
  ...
  '0 8 * * *', -- Run every day at 08:00 UTC
  $$
  SELECT net.http_post(
      url:='https://slvgrifmpyfwaewzeawn.supabase.co/functions/v1/send-reminders',
